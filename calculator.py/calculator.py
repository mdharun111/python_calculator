...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='4',relief='flat',bg='yellow',command=lambda:self.Show(4)).place(x=0 ,y=200)
        ...
        Button(width=11,height=4,text='0',relief='flat',bg='red',command=lambda:self.Show(0)).place(x=90 ,y=350)
